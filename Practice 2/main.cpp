...
void house()
{
    ...
    glVertex2f(-0.43f, 0.11f); //house 2 Door
    ...
    glVertex2f(-0.45f, 0.04f); //down left
    ...
    glVertex3f(-0.23f, 0.30f, 0.0f);
    glVertex3f(-0.17f, 0.27f, 0.0f);  // House 3 Triangular shape
    ...
    glVertex2f(-0.18f, 0.25f);  //**right side
...
//**House4
    ...
    glVertex3f(0.23f, 0.30f, 0.0f);
    glVertex3f(0.17f, 0.27f, 0.0f);  // House 4 Triangular shape
    glVertex3f(0.29f, 0.27f, 0.0f);
    glEnd();
    ...
    glLineWidth(7.5);
    glBegin(GL_LINES);
    glColor3ub(72, 22, 177);
    glVertex2f(0.41f, 0.12f);
    glVertex2f(0.41f, 0.0f);  // House 5 Door-Line
    ...
    glVertex2f(0.43f, 0.0f);
    glVertex2f(0.39f, 0.0f);
    glVertex2f(0.39f, 0.12f);  // House 5 Door
    ...
    glVertex3f(0.64f, 0.44f, 0.0f);  // House6 Triangular shape
    glVertex3f(0.52f, 0.44f, 0.0f);
    glEnd();
...
void houseN()
{
    /*House1*/ /*left side*/
    glBegin(GL_QUADS);
    glColor3ub(60, 126, 103);
    glVertex2f(-0.64f, 0.0f);
    glVertex2f(-0.52f, 0.0f);
    glVertex2f(-0.52f, 0.32f);
    glVertex2f(-0.64f, 0.32f);

    glColor3ub(227, 188, 15);         //window
    glVertex2f(-0.63f, 0.04f);
    glVertex2f(-0.59f, 0.04f);
    glVertex2f(-0.59f, 0.09f);
    glVertex2f(-0.63f, 0.09f);
    ...
    glBegin(GL_QUADS);
    glColor3ub(192, 171, 104);
    glVertex2f(-0.29f, 0.0f);
    glVertex2f(-0.17f, 0.0f);
    glVertex2f(-0.17f, 0.27f);
    glVertex2f(-0.29f, 0.27f);

    glColor3ub(210, 210, 210); // left 1
    glVertex2f(-0.28f, 0.03f);
    glVertex2f(-0.24f, 0.03f);
    glVertex2f(-0.24f, 0.09f);
    glVertex2f(-0.28f, 0.09f);
